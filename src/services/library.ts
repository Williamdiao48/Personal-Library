...
export const libraryService = {
  ...
  saveScrollPos: (id: string, chapter: number, scrollY: number) =>
    window.api.library.saveScrollPos(id, chapter, scrollY),
  ...
  setCover: (id: string, data: ArrayBuffer, ext: string) =>
    window.api.library.setCover(id, data, ext),
  ...
  setStatus: (id: string, status: import('../types').ReadingStatus | null) =>
    window.api.library.setStatus(id, status),
